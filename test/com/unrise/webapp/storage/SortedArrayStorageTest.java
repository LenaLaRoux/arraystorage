...
class SortedArrayStorageTest extends AbstractArrayStorageTest {
    ...
    void save() {
        ...
        Assertions.assertSame(r4, storage.getAll()[3]);
        Assertions.assertSame(r5, storage.getAll()[4]);
    ...
    void delete() {
        ...
        Assertions.assertEquals(storage.getAll()[0], storage.get(UUID2));
        Assertions.assertEquals(storage.getAll()[1], storage.get(UUID3));
