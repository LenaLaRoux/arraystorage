...
class SortedArrayStorageTest extends AbstractArrayStorageTest {
    ...
    void save() {
        ...
        assertSame(r4, storage.getAll()[3]);
        assertSame(r5, storage.getAll()[4]);
    ...
    void delete() {
        ...
        assertEquals(storage.getAll()[0], storage.get(UUID2));
        assertEquals(storage.getAll()[1], storage.get(UUID3));
